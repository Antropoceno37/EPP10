...
# normalize_cohort is the canonical mapping from raw study cohort strings to
# preregistered cohort_v10_primary / _sensitivity / surgery_status etc.
# It lives in R/cohort_map.R so it can be unit-tested without the full ETL.
source("/Users/hmva/EPP10/R/cohort_map.R")
